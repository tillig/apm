...
class ScriptExecutionFormatter:
    ...
    def format_runtime_execution(
        self, runtime: str, command: str, content_length: int
    ) -> list[str]:
        ...
        runtime_colors = {"copilot": "blue", "codex": "green", "llm": "magenta", "unknown": "white"}
    ...
    def format_execution_success(
        self, runtime: str, execution_time: float | None = None
    ) -> list[str]:
    ...
    def format_execution_error(
        self, runtime: str, error_code: int, error_msg: str | None = None
    ) -> list[str]:
    ...
    def format_auto_discovery_message(
        self, script_name: str, prompt_file: Path, runtime: str
    ) -> str:
