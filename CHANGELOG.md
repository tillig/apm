...
- `apm compile` no longer overwrites a hand-authored `.github/copilot-instructions.md`; if the file lacks the APM-generated marker, regeneration is skipped with a warning. **Migration:** to adopt APM management of an existing file, either delete it and re-run `apm compile`, or prepend the APM marker line manually. (#1048)
